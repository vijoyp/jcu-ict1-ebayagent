...
Partial Class cartComplete
    ...
    Private Sub setAll()
        ...
        If Not res Is Nothing Then
            ...
            If Not res.Item.ConvertedBuyItNowPrice Is Nothing Then
                setItemC(res.Item.ConvertedBuyItNowPrice.Value() * 1.8)
            Else
                setItemC(res.Item.ConvertedCurrentPrice.Value() * 1.8)
            End If
    ...
    Private Sub setTax(ByVal itemc As String, ByVal shippingc As String)
        Me.taxc = (CType(itemc, Double) + CType(shippingc, Double)) * 0.07
    ...
    Private Function makeoffer() As Boolean
        ...
        Dim buyamt As Double = getItemC() / 1.8
    ...
    Public Sub genOrder()
        ...
        temp = temp & "GST 7% S$: " & FormatNumber((getshippingC() + getItemC()) * 0.07, 2) & "<br>"
