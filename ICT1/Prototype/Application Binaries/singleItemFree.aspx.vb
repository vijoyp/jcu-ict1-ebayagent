        ...
        If Not res.ItemArray Is Nothing Then
            ...
            If res.ItemArray.Count > 1 Then
                ...
                For i = 0 To res.ItemArray.Count - 1
                    ...
                    PHRecItems.Controls.Add(New LiteralControl("<td width=82 class=Result2>" & "<a href='singleitemFree.aspx?pageno=" & getCPage() & "&catparent=" & getCatID() & "&itemname=" & getSearchTerm() & "&itemid=" & res.ItemArray(i).ItemID & "&shipping=" & Shippingcost & "&localvalue=" & getLocal() & "'>More info</a></td>"))
                    phRecItems.Controls.Add(New LiteralControl("</tr>"))
                    phRecItems.Controls.Add(New LiteralControl("<tr>"))
