        ...
        Else
            ...
            If totalpages > 1 Then
                ...
                For i = 1 To totalpages
                    ...
                    Else
                        PlaceHolder1.Controls.Add(New LiteralControl(display1 & "<a href=""express.aspx?pageno=" & i & "&catparent=" & getCatID() & "&itemname=" & Server.UrlPathEncode(getSearchTerm()) & """><u>" & i & "</u></a>"))
                    End If
