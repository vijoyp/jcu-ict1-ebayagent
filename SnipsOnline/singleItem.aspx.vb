    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not m Is Nothing Then
            ...
            If Request.QueryString("itemId") <> "" Then
                ...
                PlaceHolder2.Controls.Add(New LiteralControl("<< <a href=""express.aspx?catParent=" & getCatID() & "&itemName=" & Server.UrlPathEncode(getSearchTerm()) & "&pageno=" & getCPage() & "&localvalue=" & getLocal() & """>Back to Search</a>"))
                ...
                If Not res Is Nothing Then
                    ...
                    buynowbtn.PostBackUrl = "cart.aspx?itemid=" & res.Item.ItemID & "&catParent=" & getCatID() & "&itemName=" & Server.UrlPathEncode(getSearchTerm()) & "&pageno=" & getCPage() '& "&localvalue=" & getLocal() & "&shipping=" & getshippingC()

                    Dim itemIDHidden As HiddenField = New HiddenField
                    itemIDHidden.ID = "itemID"
                    itemIDHidden.Value = res.Item.ItemID
                    PHBuyNow.Controls.Add(itemIDHidden)
                    Dim localCatHidden As HiddenField = New HiddenField
                    localCatHidden.ID = "localValue"
                    localCatHidden.Value = getLocal()
                    PHBuyNow.Controls.Add(localCatHidden)

                    buynowbtn.ImageUrl = "./images/addtocart.png"
        ...
        If Not res.ItemArray Is Nothing Then
            ...
            If res.ItemArray.Count > 1 Then
                ...
                For i = 0 To res.ItemArray.Count - 1
                    ...
                    phRecItems.Controls.Add(New LiteralControl("<td width=82 class=Result2>" & "<a href='singleitem.aspx?pageno=" & getCPage() & "&catparent=" & getCatID() & "&itemname=" & getSearchTerm() & "&itemid=" & res.ItemArray(i).ItemID & "&shipping=" & Shippingcost & "&localvalue=" & getLocal() & "'>More info</a></td>"))
                    phRecItems.Controls.Add(New LiteralControl("</tr>"))
                    phRecItems.Controls.Add(New LiteralControl("<tr>"))
